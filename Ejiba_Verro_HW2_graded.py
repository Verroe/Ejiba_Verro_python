...
#Number 4
#Stuart- Correct, but you could still solve this without knowing any number theory
#by implementing long division algorithmicallly. Good answer though using NT.
...
#Number 5
#Stuart- Good solution, this is a hard problem.
...
#Stuart- So the recursion step actually breaks this code. Try running it on 9. If you replaced it with
#False then the code would work, but not be recursive. When using recursion you typically
#need to shrink or somehow get the code closer to a termination step. This sends it into
#an infinite loop.
