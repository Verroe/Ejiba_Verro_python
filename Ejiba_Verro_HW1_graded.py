...
#problem should be wrapped by a function definition. Nice addition to use lower case.
...
#Stuart- your function takes a filename, but it does not open the file to read the lines.
# I think you accidentally deleted a line or two at the start of your function. 
# It is also best practice to define variables (newset, rset) inside the function, otherwise
# if I wanted to run hapax twice these variables (and the words within them) persist after the first run.
